resource "aws_iam_role" "web_host" {
  name = "${local.resource_prefix.value}-web-host"
...
resource "aws_iam_instance_profile" "web_host" {
  name = "${local.resource_prefix.value}-web-host"
  role = "${aws_iam_role.web_host.name}"
}
...
resource "aws_instance" "web_host" {
  ...
  iam_instance_profile = "${aws_iam_instance_profile.web_host.name}"
  user_data            = <<EOF
#! /bin/bash
sudo apt-get update
